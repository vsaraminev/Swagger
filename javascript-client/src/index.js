...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Comment', 'model/Order', 'model/Part', 'model/Project', 'model/User', 'api/PartApi', 'api/ProjectApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Comment'), require('./model/Order'), require('./model/Part'), require('./model/Project'), require('./model/User'), require('./api/PartApi'), require('./api/ProjectApi'));
  }
}(function(ApiClient, Comment, Order, Part, Project, User, PartApi, ProjectApi) {
  'use strict';
