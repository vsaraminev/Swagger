...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the partEditIdPut operation.
     * @callback module:api/PartApi~partEditIdPutCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * Update a part
     * @param {String} id Id of the part to be updated
     * @param {module:model/Part} body Updated part object
     * @param {module:api/PartApi~partEditIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.partEditIdPut = function(id, body, callback) {
      var postBody = body;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling partEditIdPut");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling partEditIdPut");
      }
